<?php
@session_start() ;
$_SESSION['scriptcase']['apps_grid_sec_users']['sc_process_barr'] = true;
require_once('../apps_grid_sec_users/index.php');
unset($_SESSION['scriptcase']['apps_grid_sec_users']['sc_process_barr']);
$ExportCtrl = new apps_grid_sec_users_export_control;
$ExportCtrl->Export_barr();

class apps_grid_sec_users_export_control
{
