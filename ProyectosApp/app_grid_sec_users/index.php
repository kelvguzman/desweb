<?php
   ...
   $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_conf']       = "C:/Program Files/NetMake/v9/wwwroot/scriptcase/conf";
   ...
   $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_doc']        = "C:/Program Files/NetMake/v9/wwwrootC:/Program Files/NetMake/v9/wwwroot/scriptcase/file/doc";
   $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_conexao']         = "ProyectosApp";
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_conexao'], $this->root . $this->path_prod, 'ProyectosApp'); 
      } 
      else 
      { 
          ob_start();
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       if (is_file($root . $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_imag_temp'] . "/sc_apl_default_ProyectosApp.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_imag_temp'] . "/sc_apl_default_ProyectosApp.txt"));
