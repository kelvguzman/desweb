...
//--- 
   ...
   if ($this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['det_print'] == "print")
   {
   ...
   $nm_saida->saida("</HEAD>\r\n");
   if (!$this->Ini->Export_html_zip && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['det_print'] == "print")
   {
       $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
...
//--- 
   ...
   { 
       ...
       {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Dprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "app_grid_sec_users/app_grid_sec_users_config_print.php?nm_opc=detalhe&nm_cor=PB&language=es&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
       }
