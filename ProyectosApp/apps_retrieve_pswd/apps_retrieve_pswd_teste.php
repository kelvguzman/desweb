<?php  
  ...
  session_start() ;
  class apps_retrieve_pswd_form_teste
  {
   function apps_retrieve_pswd_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "apps_retrieve_pswd/img";
...
?> 
<br> 
<B><FONT SIZE="4">apps_retrieve_pswd</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="apps_retrieve_pswd"> 
</form> 
...
<?php
  ...
  $frm_teste = new apps_retrieve_pswd_form_teste();
  $frm_teste->apps_retrieve_pswd_teste();
?>
