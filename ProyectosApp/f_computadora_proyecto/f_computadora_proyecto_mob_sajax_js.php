  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_f_computadora_proyecto_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_f_computadora_proyecto_mob_validate_id_computadora()
  {
    var nomeCampo_id_computadora = "id_computadora";
    var var_id_computadora = scAjaxGetFieldSelect(nomeCampo_id_computadora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_computadora_proyecto_mob_validate_id_computadora(var_id_computadora, var_script_case_init, do_ajax_f_computadora_proyecto_mob_validate_id_computadora_cb);
  } // do_ajax_f_computadora_proyecto_mob_validate_id_computadora

  function do_ajax_f_computadora_proyecto_mob_validate_id_computadora_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_computadora_proyecto_mob_validate_id_computadora_cb

  // ---------- Validate id_proyecto
  function do_ajax_f_computadora_proyecto_mob_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldSelect(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_computadora_proyecto_mob_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_f_computadora_proyecto_mob_validate_id_proyecto_cb);
  } // do_ajax_f_computadora_proyecto_mob_validate_id_proyecto

  function do_ajax_f_computadora_proyecto_mob_validate_id_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_computadora_proyecto_mob_validate_id_proyecto_cb

  // ---------- Validate fecha_asignacion
  function do_ajax_f_computadora_proyecto_mob_validate_fecha_asignacion()
  {
    ...
    setTimeout(function() {
      var var_fecha_asignacion = scAjaxGetFieldText(nomeCampo_fecha_asignacion);
      x_ajax_f_computadora_proyecto_mob_validate_fecha_asignacion(var_fecha_asignacion, var_script_case_init, do_ajax_f_computadora_proyecto_mob_validate_fecha_asignacion_cb);
    }, 200);
  } // do_ajax_f_computadora_proyecto_mob_validate_fecha_asignacion

  function do_ajax_f_computadora_proyecto_mob_validate_fecha_asignacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_computadora_proyecto_mob_validate_fecha_asignacion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_f_computadora_proyecto_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_f_computadora_proyecto_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_computadora = scAjaxGetFieldSelect("id_computadora");
    ...
    scAjaxProcOn();
    x_ajax_f_computadora_proyecto_mob_submit_form(var_id_computadora, var_id_proyecto, var_fecha_asignacion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_f_computadora_proyecto_mob_submit_form_cb);
  } // do_ajax_f_computadora_proyecto_mob_submit_form

  function do_ajax_f_computadora_proyecto_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_f_computadora_proyecto_mob_submit_form_cb_after_alert);
  } // do_ajax_f_computadora_proyecto_mob_submit_form_cb
  function do_ajax_f_computadora_proyecto_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_f_computadora_proyecto_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_f_computadora_proyecto_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_f_computadora_proyecto_mob_navigate_form(var_id_computadora, var_id_proyecto, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_f_computadora_proyecto_mob_navigate_form_cb);
  } // do_ajax_f_computadora_proyecto_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['f_computadora_proyecto_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_f_computadora_proyecto_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_f_computadora_proyecto_mob_form();
    }
    scAjaxClearErrors()
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_f_computadora_proyecto_mob_navigate_form_cb_after_alert);
  } // do_ajax_f_computadora_proyecto_mob_navigate_form_cb
  function do_ajax_f_computadora_proyecto_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_f_computadora_proyecto_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_f_computadora_proyecto_mob_navigate_form_cb_after_alert
  function sc_hide_f_computadora_proyecto_mob_form()
  {
  ...
  ajax_field_list[2] = "fecha_asignacion";
