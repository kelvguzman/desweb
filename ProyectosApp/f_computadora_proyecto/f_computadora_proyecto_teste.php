<?php  
  ...
  session_start() ;
  class f_computadora_proyecto_form_teste
  {
   function f_computadora_proyecto_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "f_computadora_proyecto/img";
...
?> 
<br> 
<B><FONT SIZE="4">f_computadora_proyecto</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="f_computadora_proyecto"> 
</form> 
...
<?php
  ...
  $frm_teste = new f_computadora_proyecto_form_teste();
  $frm_teste->f_computadora_proyecto_teste();
?>
