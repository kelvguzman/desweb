...
//
   ...
   $_SESSION['scriptcase']['app_change_pswd']['glo_nm_path_doc']        = "C:/Program Files/NetMake/v9/wwwrootC:/Program Files/NetMake/v9/wwwroot/scriptcase/file/doc";
   $_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao']         = "ProyectosApp";
   $NM_dir_atual = getcwd();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao'], $this->root . $this->path_prod, 'ProyectosApp'); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao'], $this->root . $this->path_prod, 'ProyectosApp', 1, true);
    }
    else {
