<?php  
  ...
  session_start() ;
  class f_cliente_form_teste
  {
   function f_cliente_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "f_cliente/img";
...
?> 
<br> 
<B><FONT SIZE="4">f_cliente</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="f_cliente"> 
</form> 
...
<?php
  ...
  $frm_teste = new f_cliente_form_teste();
  $frm_teste->f_cliente_teste();
?>
