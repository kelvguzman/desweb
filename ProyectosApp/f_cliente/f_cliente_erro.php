...
$old_error_handler = set_error_handler("f_cliente_scriptcase_error_handler");

function f_cliente_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['f_cliente']['contr_erro']) && $_SESSION['scriptcase']['f_cliente']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_f_cliente->contr_f_cliente->Apl_com_erro = true;
            if ($inicial_f_cliente->contr_f_cliente->NM_ajax_flag)
            {
                $inicial_f_cliente->contr_f_cliente->NM_ajax_info['errList']['geral_f_cliente'][] = $msg;
                return;
            }
            f_cliente_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function f_cliente_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['f_cliente'])  && '' != $_SESSION['scriptcase']['error_icon']['f_cliente'])  ? $_SESSION['scriptcase']['error_icon']['f_cliente']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['f_cliente']) && '' != $_SESSION['scriptcase']['error_span_title']['f_cliente']) ? $_SESSION['scriptcase']['error_span_title']['f_cliente'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['f_cliente']) && '' != $_SESSION['scriptcase']['error_icon_title']['f_cliente']) ? $_SESSION['scriptcase']['error_icon_title']['f_cliente'] : '';
?>
