...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_cliente
  function do_ajax_f_cliente_validate_id_cliente()
  {
    var nomeCampo_id_cliente = "id_cliente";
    var var_id_cliente = scAjaxGetFieldHidden(nomeCampo_id_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_cliente_validate_id_cliente(var_id_cliente, var_script_case_init, do_ajax_f_cliente_validate_id_cliente_cb);
  } // do_ajax_f_cliente_validate_id_cliente

  function do_ajax_f_cliente_validate_id_cliente_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_cliente_validate_id_cliente_cb

  // ---------- Validate empresa
  function do_ajax_f_cliente_validate_empresa()
  {
    var nomeCampo_empresa = "empresa";
    var var_empresa = scAjaxGetFieldText(nomeCampo_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_cliente_validate_empresa(var_empresa, var_script_case_init, do_ajax_f_cliente_validate_empresa_cb);
  } // do_ajax_f_cliente_validate_empresa

  function do_ajax_f_cliente_validate_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "empresa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_cliente_validate_empresa_cb

  // ---------- Validate nombre_contacto
  function do_ajax_f_cliente_validate_nombre_contacto()
  {
    var nomeCampo_nombre_contacto = "nombre_contacto";
    var var_nombre_contacto = scAjaxGetFieldText(nomeCampo_nombre_contacto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_cliente_validate_nombre_contacto(var_nombre_contacto, var_script_case_init, do_ajax_f_cliente_validate_nombre_contacto_cb);
  } // do_ajax_f_cliente_validate_nombre_contacto

  function do_ajax_f_cliente_validate_nombre_contacto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_cliente_validate_nombre_contacto_cb

  // ---------- Validate telefono
  function do_ajax_f_cliente_validate_telefono()
  {
    var nomeCampo_telefono = "telefono";
    var var_telefono = scAjaxGetFieldText(nomeCampo_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_cliente_validate_telefono(var_telefono, var_script_case_init, do_ajax_f_cliente_validate_telefono_cb);
  } // do_ajax_f_cliente_validate_telefono

  function do_ajax_f_cliente_validate_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_cliente_validate_telefono_cb

  // ---------- Validate correo_electronico
  function do_ajax_f_cliente_validate_correo_electronico()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_cliente_validate_correo_electronico(var_correo_electronico, var_script_case_init, do_ajax_f_cliente_validate_correo_electronico_cb);
  } // do_ajax_f_cliente_validate_correo_electronico

  function do_ajax_f_cliente_validate_correo_electronico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_cliente_validate_correo_electronico_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_f_cliente_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_f_cliente_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_f_cliente_submit_form(var_id_cliente, var_empresa, var_nombre_contacto, var_telefono, var_correo_electronico, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_f_cliente_submit_form_cb);
  } // do_ajax_f_cliente_submit_form

  function do_ajax_f_cliente_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_f_cliente_submit_form_cb_after_alert);
  } // do_ajax_f_cliente_submit_form_cb
  function do_ajax_f_cliente_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_f_cliente_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_f_cliente_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_f_cliente_navigate_form(var_id_cliente, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_f_cliente_navigate_form_cb);
  } // do_ajax_f_cliente_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['f_cliente']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_f_cliente_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_f_cliente_navigate_form_cb_after_alert);
  } // do_ajax_f_cliente_navigate_form_cb
  function do_ajax_f_cliente_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_f_cliente_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_f_cliente_navigate_form_cb_after_alert
  function sc_hide_f_cliente_form()
  {
