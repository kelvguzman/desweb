  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_f_servicio_proyecto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_f_servicio_proyecto_validate_id_servicio()
  {
    var nomeCampo_id_servicio = "id_servicio";
    var var_id_servicio = scAjaxGetFieldHidden(nomeCampo_id_servicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_servicio_proyecto_validate_id_servicio(var_id_servicio, var_script_case_init, do_ajax_f_servicio_proyecto_validate_id_servicio_cb);
  } // do_ajax_f_servicio_proyecto_validate_id_servicio

  function do_ajax_f_servicio_proyecto_validate_id_servicio_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_servicio_proyecto_validate_id_servicio_cb

  // ---------- Validate descripcion_servicio
  function do_ajax_f_servicio_proyecto_validate_descripcion_servicio()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_servicio_proyecto_validate_descripcion_servicio(var_descripcion_servicio, var_script_case_init, do_ajax_f_servicio_proyecto_validate_descripcion_servicio_cb);
  } // do_ajax_f_servicio_proyecto_validate_descripcion_servicio

  function do_ajax_f_servicio_proyecto_validate_descripcion_servicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_servicio_proyecto_validate_descripcion_servicio_cb

  // ---------- Validate id_proyecto
  function do_ajax_f_servicio_proyecto_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldSelect(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_servicio_proyecto_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_f_servicio_proyecto_validate_id_proyecto_cb);
  } // do_ajax_f_servicio_proyecto_validate_id_proyecto

  function do_ajax_f_servicio_proyecto_validate_id_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_servicio_proyecto_validate_id_proyecto_cb

  // ---------- Validate fecha_contratacion
  function do_ajax_f_servicio_proyecto_validate_fecha_contratacion()
  {
    ...
    setTimeout(function() {
      var var_fecha_contratacion = scAjaxGetFieldText(nomeCampo_fecha_contratacion);
      x_ajax_f_servicio_proyecto_validate_fecha_contratacion(var_fecha_contratacion, var_script_case_init, do_ajax_f_servicio_proyecto_validate_fecha_contratacion_cb);
    }, 200);
  } // do_ajax_f_servicio_proyecto_validate_fecha_contratacion

  function do_ajax_f_servicio_proyecto_validate_fecha_contratacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_servicio_proyecto_validate_fecha_contratacion_cb

  // ---------- Validate id_proveedor
  function do_ajax_f_servicio_proyecto_validate_id_proveedor()
  {
    var nomeCampo_id_proveedor = "id_proveedor";
    var var_id_proveedor = scAjaxGetFieldSelect(nomeCampo_id_proveedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_servicio_proyecto_validate_id_proveedor(var_id_proveedor, var_script_case_init, do_ajax_f_servicio_proyecto_validate_id_proveedor_cb);
  } // do_ajax_f_servicio_proyecto_validate_id_proveedor

  function do_ajax_f_servicio_proyecto_validate_id_proveedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_servicio_proyecto_validate_id_proveedor_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_f_servicio_proyecto_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_f_servicio_proyecto_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_f_servicio_proyecto_submit_form(var_id_servicio, var_descripcion_servicio, var_id_proyecto, var_fecha_contratacion, var_id_proveedor, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_f_servicio_proyecto_submit_form_cb);
  } // do_ajax_f_servicio_proyecto_submit_form

  function do_ajax_f_servicio_proyecto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_f_servicio_proyecto_submit_form_cb_after_alert);
  } // do_ajax_f_servicio_proyecto_submit_form_cb
  function do_ajax_f_servicio_proyecto_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_f_servicio_proyecto_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_f_servicio_proyecto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_f_servicio_proyecto_navigate_form(var_id_servicio, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_f_servicio_proyecto_navigate_form_cb);
  } // do_ajax_f_servicio_proyecto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['f_servicio_proyecto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_f_servicio_proyecto_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_f_servicio_proyecto_form();
    }
    scAjaxClearErrors()
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_f_servicio_proyecto_navigate_form_cb_after_alert);
  } // do_ajax_f_servicio_proyecto_navigate_form_cb
  function do_ajax_f_servicio_proyecto_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_f_servicio_proyecto_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_f_servicio_proyecto_navigate_form_cb_after_alert
  function sc_hide_f_servicio_proyecto_form()
  {
