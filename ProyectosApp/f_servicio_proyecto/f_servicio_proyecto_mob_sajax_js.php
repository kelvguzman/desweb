  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_f_servicio_proyecto_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_servicio
  function do_ajax_f_servicio_proyecto_mob_validate_id_servicio()
  {
    var nomeCampo_id_servicio = "id_servicio";
    var var_id_servicio = scAjaxGetFieldHidden(nomeCampo_id_servicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_servicio_proyecto_mob_validate_id_servicio(var_id_servicio, var_script_case_init, do_ajax_f_servicio_proyecto_mob_validate_id_servicio_cb);
  } // do_ajax_f_servicio_proyecto_mob_validate_id_servicio

  function do_ajax_f_servicio_proyecto_mob_validate_id_servicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_servicio";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_servicio_proyecto_mob_validate_id_servicio_cb

  // ---------- Validate descripcion_servicio
  function do_ajax_f_servicio_proyecto_mob_validate_descripcion_servicio()
  {
    var nomeCampo_descripcion_servicio = "descripcion_servicio";
    var var_descripcion_servicio = scAjaxGetFieldText(nomeCampo_descripcion_servicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_servicio_proyecto_mob_validate_descripcion_servicio(var_descripcion_servicio, var_script_case_init, do_ajax_f_servicio_proyecto_mob_validate_descripcion_servicio_cb);
  } // do_ajax_f_servicio_proyecto_mob_validate_descripcion_servicio

  function do_ajax_f_servicio_proyecto_mob_validate_descripcion_servicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "descripcion_servicio";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_servicio_proyecto_mob_validate_descripcion_servicio_cb

  // ---------- Validate id_proyecto
  function do_ajax_f_servicio_proyecto_mob_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldSelect(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_servicio_proyecto_mob_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_f_servicio_proyecto_mob_validate_id_proyecto_cb);
  } // do_ajax_f_servicio_proyecto_mob_validate_id_proyecto

  function do_ajax_f_servicio_proyecto_mob_validate_id_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_servicio_proyecto_mob_validate_id_proyecto_cb

  // ---------- Validate fecha_contratacion
  function do_ajax_f_servicio_proyecto_mob_validate_fecha_contratacion()
  {
    ...
    setTimeout(function() {
      var var_fecha_contratacion = scAjaxGetFieldText(nomeCampo_fecha_contratacion);
      x_ajax_f_servicio_proyecto_mob_validate_fecha_contratacion(var_fecha_contratacion, var_script_case_init, do_ajax_f_servicio_proyecto_mob_validate_fecha_contratacion_cb);
    }, 200);
  } // do_ajax_f_servicio_proyecto_mob_validate_fecha_contratacion

  function do_ajax_f_servicio_proyecto_mob_validate_fecha_contratacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_servicio_proyecto_mob_validate_fecha_contratacion_cb

  // ---------- Validate id_proveedor
  function do_ajax_f_servicio_proyecto_mob_validate_id_proveedor()
  {
    var nomeCampo_id_proveedor = "id_proveedor";
    var var_id_proveedor = scAjaxGetFieldSelect(nomeCampo_id_proveedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_servicio_proyecto_mob_validate_id_proveedor(var_id_proveedor, var_script_case_init, do_ajax_f_servicio_proyecto_mob_validate_id_proveedor_cb);
  } // do_ajax_f_servicio_proyecto_mob_validate_id_proveedor

  function do_ajax_f_servicio_proyecto_mob_validate_id_proveedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_servicio_proyecto_mob_validate_id_proveedor_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_f_servicio_proyecto_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_f_servicio_proyecto_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_servicio = scAjaxGetFieldHidden("id_servicio");
    var var_descripcion_servicio = scAjaxGetFieldText("descripcion_servicio");
    ...
    scAjaxProcOn();
    x_ajax_f_servicio_proyecto_mob_submit_form(var_id_servicio, var_descripcion_servicio, var_id_proyecto, var_fecha_contratacion, var_id_proveedor, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_f_servicio_proyecto_mob_submit_form_cb);
  } // do_ajax_f_servicio_proyecto_mob_submit_form

  function do_ajax_f_servicio_proyecto_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_servicio");
      scAjaxHideErrorDisplay("descripcion_servicio");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_f_servicio_proyecto_mob_submit_form_cb_after_alert);
  } // do_ajax_f_servicio_proyecto_mob_submit_form_cb
  function do_ajax_f_servicio_proyecto_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_f_servicio_proyecto_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_f_servicio_proyecto_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("fecha_contratacion");
    scAjaxHideErrorDisplay("id_proveedor");
    var var_id_servicio = document.F2.id_servicio.value;
    ...
    scAjaxProcOn();
    x_ajax_f_servicio_proyecto_mob_navigate_form(var_id_servicio, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_f_servicio_proyecto_mob_navigate_form_cb);
  } // do_ajax_f_servicio_proyecto_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['f_servicio_proyecto_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_f_servicio_proyecto_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_f_servicio_proyecto_mob_form();
    }
    scAjaxClearErrors()
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_servicio.value = scAjaxGetKeyValue("id_servicio");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_f_servicio_proyecto_mob_navigate_form_cb_after_alert);
  } // do_ajax_f_servicio_proyecto_mob_navigate_form_cb
  function do_ajax_f_servicio_proyecto_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_f_servicio_proyecto_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_f_servicio_proyecto_mob_navigate_form_cb_after_alert
  function sc_hide_f_servicio_proyecto_mob_form()
  {
  ...
  ajax_field_list[0] = "id_servicio";
  ajax_field_list[1] = "descripcion_servicio";
  ajax_field_list[2] = "id_proyecto";
  ajax_field_list[3] = "fecha_contratacion";
  ajax_field_list[4] = "id_proveedor";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_servicio": {"label": "Id Servicio", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "descripcion_servicio": {"label": "Descripcion Servicio", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "fecha_contratacion": {"label": "Fecha Contratacion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "id_servicio": new Array(),
    "descripcion_servicio": new Array(),
    "id_proyecto": new Array(),
    "fecha_contratacion": new Array(),
    "id_proveedor": new Array()
  };
  ajax_field_mult["id_servicio"][1] = "id_servicio";
  ajax_field_mult["descripcion_servicio"][1] = "descripcion_servicio";
  ...
  var ajax_field_id = {
    "id_servicio": new Array("hidden_field_label_id_servicio", "hidden_field_data_id_servicio"),
    "descripcion_servicio": new Array("hidden_field_label_descripcion_servicio", "hidden_field_data_descripcion_servicio"),
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("descripcion_servicio" == sIndex)
    {
