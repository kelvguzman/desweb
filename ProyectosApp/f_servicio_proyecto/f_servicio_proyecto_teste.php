<?php  
  ...
  session_start() ;
  class f_servicio_proyecto_form_teste
  {
   function f_servicio_proyecto_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "f_servicio_proyecto/img";
...
?> 
<br> 
<B><FONT SIZE="4">f_servicio_proyecto</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="f_servicio_proyecto"> 
</form> 
...
<?php
  ...
  $frm_teste = new f_servicio_proyecto_form_teste();
  $frm_teste->f_servicio_proyecto_teste();
?>
