  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_f_proyecto_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_f_proyecto_mob_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldHidden(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_proyecto_mob_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_f_proyecto_mob_validate_id_proyecto_cb);
  } // do_ajax_f_proyecto_mob_validate_id_proyecto

  function do_ajax_f_proyecto_mob_validate_id_proyecto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_proyecto_mob_validate_id_proyecto_cb

  // ---------- Validate nombre_proyecto
  function do_ajax_f_proyecto_mob_validate_nombre_proyecto()
  {
    var nomeCampo_nombre_proyecto = "nombre_proyecto";
    var var_nombre_proyecto = scAjaxGetFieldText(nomeCampo_nombre_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_proyecto_mob_validate_nombre_proyecto(var_nombre_proyecto, var_script_case_init, do_ajax_f_proyecto_mob_validate_nombre_proyecto_cb);
  } // do_ajax_f_proyecto_mob_validate_nombre_proyecto

  function do_ajax_f_proyecto_mob_validate_nombre_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_proyecto_mob_validate_nombre_proyecto_cb

  // ---------- Validate tiempo_estimado
  function do_ajax_f_proyecto_mob_validate_tiempo_estimado()
  {
    var nomeCampo_tiempo_estimado = "tiempo_estimado";
    var var_tiempo_estimado = scAjaxGetFieldText(nomeCampo_tiempo_estimado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_proyecto_mob_validate_tiempo_estimado(var_tiempo_estimado, var_script_case_init, do_ajax_f_proyecto_mob_validate_tiempo_estimado_cb);
  } // do_ajax_f_proyecto_mob_validate_tiempo_estimado

  function do_ajax_f_proyecto_mob_validate_tiempo_estimado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_proyecto_mob_validate_tiempo_estimado_cb

  // ---------- Validate id_responsable
  function do_ajax_f_proyecto_mob_validate_id_responsable()
  {
    var nomeCampo_id_responsable = "id_responsable";
    var var_id_responsable = scAjaxGetFieldSelect(nomeCampo_id_responsable);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_proyecto_mob_validate_id_responsable(var_id_responsable, var_script_case_init, do_ajax_f_proyecto_mob_validate_id_responsable_cb);
  } // do_ajax_f_proyecto_mob_validate_id_responsable

  function do_ajax_f_proyecto_mob_validate_id_responsable_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_proyecto_mob_validate_id_responsable_cb

  // ---------- Validate id_categoria
  function do_ajax_f_proyecto_mob_validate_id_categoria()
  {
    var nomeCampo_id_categoria = "id_categoria";
    var var_id_categoria = scAjaxGetFieldSelect(nomeCampo_id_categoria);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_proyecto_mob_validate_id_categoria(var_id_categoria, var_script_case_init, do_ajax_f_proyecto_mob_validate_id_categoria_cb);
  } // do_ajax_f_proyecto_mob_validate_id_categoria

  function do_ajax_f_proyecto_mob_validate_id_categoria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_proyecto_mob_validate_id_categoria_cb

  // ---------- Validate fecha_creacion
  function do_ajax_f_proyecto_mob_validate_fecha_creacion()
  {
    var nomeCampo_fecha_creacion = "fecha_creacion";
    var var_fecha_creacion = scAjaxGetFieldText(nomeCampo_fecha_creacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_proyecto_mob_validate_fecha_creacion(var_fecha_creacion, var_script_case_init, do_ajax_f_proyecto_mob_validate_fecha_creacion_cb);
  } // do_ajax_f_proyecto_mob_validate_fecha_creacion

  function do_ajax_f_proyecto_mob_validate_fecha_creacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_proyecto_mob_validate_fecha_creacion_cb

  // ---------- Validate id_cliente
  function do_ajax_f_proyecto_mob_validate_id_cliente()
  {
    var nomeCampo_id_cliente = "id_cliente";
    var var_id_cliente = scAjaxGetFieldSelect(nomeCampo_id_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_proyecto_mob_validate_id_cliente(var_id_cliente, var_script_case_init, do_ajax_f_proyecto_mob_validate_id_cliente_cb);
  } // do_ajax_f_proyecto_mob_validate_id_cliente

  function do_ajax_f_proyecto_mob_validate_id_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_proyecto_mob_validate_id_cliente_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_f_proyecto_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_f_proyecto_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_f_proyecto_mob_submit_form(var_id_proyecto, var_nombre_proyecto, var_tiempo_estimado, var_id_responsable, var_id_categoria, var_fecha_creacion, var_id_cliente, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_f_proyecto_mob_submit_form_cb);
  } // do_ajax_f_proyecto_mob_submit_form

  function do_ajax_f_proyecto_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_f_proyecto_mob_submit_form_cb_after_alert);
  } // do_ajax_f_proyecto_mob_submit_form_cb
  function do_ajax_f_proyecto_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_f_proyecto_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_f_proyecto_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_f_proyecto_mob_navigate_form(var_id_proyecto, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_f_proyecto_mob_navigate_form_cb);
  } // do_ajax_f_proyecto_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_f_proyecto_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_f_proyecto_mob_navigate_form_cb_after_alert);
  } // do_ajax_f_proyecto_mob_navigate_form_cb
  function do_ajax_f_proyecto_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_f_proyecto_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_f_proyecto_mob_navigate_form_cb_after_alert
  function sc_hide_f_proyecto_mob_form()
  {
