<?php  
  ...
  session_start() ;
  class f_proyecto_form_teste
  {
   function f_proyecto_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "f_proyecto/img";
...
?> 
<br> 
<B><FONT SIZE="4">f_proyecto</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="f_proyecto"> 
</form> 
...
<?php
  ...
  $frm_teste = new f_proyecto_form_teste();
  $frm_teste->f_proyecto_teste();
?>
