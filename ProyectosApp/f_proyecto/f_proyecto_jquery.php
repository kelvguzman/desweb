...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_fecha_creacion_hora' + iSeqRow).bind('blur', function() { sc_f_proyecto_fecha_creacion_hora_onblur(this, iSeqRow) })
                                                 .bind('focus', function() { sc_f_proyecto_fecha_creacion_hora_onfocus(this, iSeqRow) });
...
function sc_f_proyecto_fecha_creacion_hora_onblur(oThis, iSeqRow) {
  do_ajax_f_proyecto_validate_fecha_creacion();
  scCssBlur(oThis);
}
...
function sc_f_proyecto_fecha_creacion_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_f_proyecto_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecha_creacion" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_f_proyecto_validate_fecha_creacion(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
