...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['f_proyecto']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['f_proyecto']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['f_proyecto']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['f_proyecto']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['f_proyecto']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['f_proyecto']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['f_proyecto']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['f_proyecto']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['f_proyecto']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['f_proyecto']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['f_proyecto']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['f_proyecto']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['f_proyecto']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['f_proyecto']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['f_proyecto']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new f_proyecto_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['f_proyecto']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['f_proyecto']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['f_proyecto'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['f_proyecto']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['f_proyecto']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('f_proyecto') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['f_proyecto']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " proyecto";
      ...
      $_SESSION['scriptcase']['error_icon']['f_proyecto']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['f_proyecto'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['f_proyecto']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['f_proyecto'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['f_proyecto'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['dados_form'];
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'f_proyecto/f_proyecto_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'f_proyecto_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'f_proyecto_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'f_proyecto_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'f_proyecto/f_proyecto_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "f_proyecto_erro.class.php"); 
      }
      $this->Erro      = new f_proyecto_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['opcao']))
         { 
             if ($this->id_proyecto != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['f_proyecto']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['sc_redir_atualiz'] == "ok")
          {
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_f_proyecto']) || !is_array($this->NM_ajax_info['errList']['geral_f_proyecto']))
              {
                  $this->NM_ajax_info['errList']['geral_f_proyecto'] = array();
              }
              $this->NM_ajax_info['errList']['geral_f_proyecto'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_tiempo_estimado(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->tiempo_estimado, 11, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_id_responsable(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_responsable) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['Lookup_id_responsable']) && !in_array($this->id_responsable, $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['Lookup_id_responsable']))
               {
                   $hasError = true;
    ...
    function ValidateField_id_categoria(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_categoria) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['Lookup_id_categoria']) && !in_array($this->id_categoria, $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['Lookup_id_categoria']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_fecha_creacion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['php_cmp_required']['fecha_creacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['php_cmp_required']['fecha_creacion'] == "on") 
           { 
              $hasError = true;
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['php_cmp_required']['fecha_creacion_hora']) || $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['php_cmp_required']['fecha_creacion_hora'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Fecha Creacion" ; 
              if (!isset($Campos_Erros['fecha_creacion_hora']))
    ...
    function ValidateField_id_cliente(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_cliente) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['Lookup_id_cliente']) && !in_array($this->id_cliente, $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['Lookup_id_cliente']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id_proyecto']['keyVal'] = f_proyecto_pack_protect_string($this->nmgp_dados_form['id_proyecto']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['Lookup_id_responsable']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['Lookup_id_responsable'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['Lookup_id_responsable']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['Lookup_id_responsable'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(f_proyecto_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', f_proyecto_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['Lookup_id_responsable'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_responsable']['valList'][$i] = f_proyecto_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['Lookup_id_categoria']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['Lookup_id_categoria'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['Lookup_id_categoria']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['Lookup_id_categoria'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['Lookup_id_categoria'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_categoria']['valList'][$i] = f_proyecto_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['Lookup_id_cliente']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['Lookup_id_cliente'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['Lookup_id_cliente']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['Lookup_id_cliente'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['Lookup_id_cliente'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_cliente']['valList'][$i] = f_proyecto_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
    ...
    if ("excluir" == $this->nmgp_opcao) {
      $this->sc_evento = $this->nmgp_opcao;
      $_SESSION['scriptcase']['f_proyecto']['contr_erro'] = 'on';
...
;
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_f_proyecto' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['f_proyecto']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          $this->nombre_proyecto = $this->nombre_proyecto_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['parms'] = "id_proyecto?#?$this->id_proyecto?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_f_proyecto = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['total'] = $qt_geral_reg_f_proyecto;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id_proyecto))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_f_proyecto = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['reg_start'] > $qt_geral_reg_f_proyecto)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['reg_start'] = $qt_geral_reg_f_proyecto; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_f_proyecto) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['reg_start'] < $qt_geral_reg_f_proyecto;
              $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("f_proyecto_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['table_refresh'])
        {
   ...
   function jqueryFAFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_f_proyecto = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['total'] = $qt_geral_reg_f_proyecto;
      $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          f_proyecto_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "f_proyecto_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['nm_run_menu'] = 2;
       $nmgp_saida_form = "f_proyecto_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['masterValue'] as $cmp_master => $val_master)
        {
?>
