  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_f_proyecto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_f_proyecto_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldHidden(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_proyecto_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_f_proyecto_validate_id_proyecto_cb);
  } // do_ajax_f_proyecto_validate_id_proyecto

  function do_ajax_f_proyecto_validate_id_proyecto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_proyecto_validate_id_proyecto_cb

  // ---------- Validate nombre_proyecto
  function do_ajax_f_proyecto_validate_nombre_proyecto()
  {
    var nomeCampo_nombre_proyecto = "nombre_proyecto";
    var var_nombre_proyecto = scAjaxGetFieldText(nomeCampo_nombre_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_proyecto_validate_nombre_proyecto(var_nombre_proyecto, var_script_case_init, do_ajax_f_proyecto_validate_nombre_proyecto_cb);
  } // do_ajax_f_proyecto_validate_nombre_proyecto

  function do_ajax_f_proyecto_validate_nombre_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_proyecto_validate_nombre_proyecto_cb

  // ---------- Validate tiempo_estimado
  function do_ajax_f_proyecto_validate_tiempo_estimado()
  {
    var nomeCampo_tiempo_estimado = "tiempo_estimado";
    var var_tiempo_estimado = scAjaxGetFieldText(nomeCampo_tiempo_estimado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_proyecto_validate_tiempo_estimado(var_tiempo_estimado, var_script_case_init, do_ajax_f_proyecto_validate_tiempo_estimado_cb);
  } // do_ajax_f_proyecto_validate_tiempo_estimado

  function do_ajax_f_proyecto_validate_tiempo_estimado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tiempo_estimado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_proyecto_validate_tiempo_estimado_cb

  // ---------- Validate id_responsable
  function do_ajax_f_proyecto_validate_id_responsable()
  {
    var nomeCampo_id_responsable = "id_responsable";
    var var_id_responsable = scAjaxGetFieldSelect(nomeCampo_id_responsable);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_proyecto_validate_id_responsable(var_id_responsable, var_script_case_init, do_ajax_f_proyecto_validate_id_responsable_cb);
  } // do_ajax_f_proyecto_validate_id_responsable

  function do_ajax_f_proyecto_validate_id_responsable_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_responsable";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_proyecto_validate_id_responsable_cb

  // ---------- Validate id_categoria
  function do_ajax_f_proyecto_validate_id_categoria()
  {
    var nomeCampo_id_categoria = "id_categoria";
    var var_id_categoria = scAjaxGetFieldSelect(nomeCampo_id_categoria);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_proyecto_validate_id_categoria(var_id_categoria, var_script_case_init, do_ajax_f_proyecto_validate_id_categoria_cb);
  } // do_ajax_f_proyecto_validate_id_categoria

  function do_ajax_f_proyecto_validate_id_categoria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_proyecto_validate_id_categoria_cb

  // ---------- Validate fecha_creacion
  function do_ajax_f_proyecto_validate_fecha_creacion()
  {
    var nomeCampo_fecha_creacion = "fecha_creacion";
    var var_fecha_creacion = scAjaxGetFieldText(nomeCampo_fecha_creacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_proyecto_validate_fecha_creacion(var_fecha_creacion, var_script_case_init, do_ajax_f_proyecto_validate_fecha_creacion_cb);
  } // do_ajax_f_proyecto_validate_fecha_creacion

  function do_ajax_f_proyecto_validate_fecha_creacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha_creacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_proyecto_validate_fecha_creacion_cb

  // ---------- Validate id_cliente
  function do_ajax_f_proyecto_validate_id_cliente()
  {
    var nomeCampo_id_cliente = "id_cliente";
    var var_id_cliente = scAjaxGetFieldSelect(nomeCampo_id_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_proyecto_validate_id_cliente(var_id_cliente, var_script_case_init, do_ajax_f_proyecto_validate_id_cliente_cb);
  } // do_ajax_f_proyecto_validate_id_cliente

  function do_ajax_f_proyecto_validate_id_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_proyecto_validate_id_cliente_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_f_proyecto_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_f_proyecto_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_proyecto = scAjaxGetFieldHidden("id_proyecto");
    var var_nombre_proyecto = scAjaxGetFieldText("nombre_proyecto");
    var var_tiempo_estimado = scAjaxGetFieldText("tiempo_estimado");
    var var_id_responsable = scAjaxGetFieldSelect("id_responsable");
    var var_id_categoria = scAjaxGetFieldSelect("id_categoria");
    var var_fecha_creacion = scAjaxGetFieldText("fecha_creacion");
    ...
    scAjaxProcOn();
    x_ajax_f_proyecto_submit_form(var_id_proyecto, var_nombre_proyecto, var_tiempo_estimado, var_id_responsable, var_id_categoria, var_fecha_creacion, var_id_cliente, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_f_proyecto_submit_form_cb);
  } // do_ajax_f_proyecto_submit_form

  function do_ajax_f_proyecto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("tiempo_estimado");
      scAjaxHideErrorDisplay("id_responsable");
      scAjaxHideErrorDisplay("id_categoria");
      scAjaxHideErrorDisplay("fecha_creacion");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_f_proyecto_submit_form_cb_after_alert);
  } // do_ajax_f_proyecto_submit_form_cb
  function do_ajax_f_proyecto_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_f_proyecto_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_f_proyecto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_f_proyecto_navigate_form(var_id_proyecto, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_f_proyecto_navigate_form_cb);
  } // do_ajax_f_proyecto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['f_proyecto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_f_proyecto_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_f_proyecto_navigate_form_cb_after_alert);
  } // do_ajax_f_proyecto_navigate_form_cb
  function do_ajax_f_proyecto_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_f_proyecto_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_f_proyecto_navigate_form_cb_after_alert
  function sc_hide_f_proyecto_form()
  {
  ...
  ajax_field_list[1] = "nombre_proyecto";
  ajax_field_list[2] = "tiempo_estimado";
  ajax_field_list[3] = "id_responsable";
  ajax_field_list[4] = "id_categoria";
  ajax_field_list[5] = "fecha_creacion";
  ajax_field_list[6] = "id_cliente";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_proyecto": {"label": "Id Proyecto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nombre_proyecto": {"label": "Nombre Proyecto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tiempo_estimado": {"label": "Tiempo Estimado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_responsable": {"label": "Id Responsable", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "fecha_creacion": {"label": "Fecha Creacion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "tiempo_estimado": new Array(),
    "id_responsable": new Array(),
    "id_categoria": new Array(),
    "fecha_creacion": new Array(),
    "id_cliente": new Array()
  };
  ajax_field_mult["id_proyecto"][1] = "id_proyecto";
  ajax_field_mult["nombre_proyecto"][1] = "nombre_proyecto";
  ajax_field_mult["tiempo_estimado"][1] = "tiempo_estimado";
  ajax_field_mult["id_responsable"][1] = "id_responsable";
  ajax_field_mult["id_categoria"][1] = "id_categoria";
  ajax_field_mult["fecha_creacion"][1] = "fecha_creacion";
  ...
  var ajax_field_id = {
    ...
    "tiempo_estimado": new Array("hidden_field_label_tiempo_estimado", "hidden_field_data_tiempo_estimado"),
    "id_responsable": new Array("hidden_field_label_id_responsable", "hidden_field_data_id_responsable"),
    "id_categoria": new Array("hidden_field_label_id_categoria", "hidden_field_data_id_categoria"),
    "fecha_creacion": new Array("hidden_field_label_fecha_creacion", "hidden_field_data_fecha_creacion"),
