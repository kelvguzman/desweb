  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_f_personal_proyecto_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_personal
  function do_ajax_f_personal_proyecto_mob_validate_id_personal()
  {
    var nomeCampo_id_personal = "id_personal";
    var var_id_personal = scAjaxGetFieldSelect(nomeCampo_id_personal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_personal_proyecto_mob_validate_id_personal(var_id_personal, var_script_case_init, do_ajax_f_personal_proyecto_mob_validate_id_personal_cb);
  } // do_ajax_f_personal_proyecto_mob_validate_id_personal

  function do_ajax_f_personal_proyecto_mob_validate_id_personal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_personal";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_personal_proyecto_mob_validate_id_personal_cb

  // ---------- Validate id_proyecto
  function do_ajax_f_personal_proyecto_mob_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldSelect(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_personal_proyecto_mob_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_f_personal_proyecto_mob_validate_id_proyecto_cb);
  } // do_ajax_f_personal_proyecto_mob_validate_id_proyecto

  function do_ajax_f_personal_proyecto_mob_validate_id_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_personal_proyecto_mob_validate_id_proyecto_cb

  // ---------- Validate fecha_asginacion
  function do_ajax_f_personal_proyecto_mob_validate_fecha_asginacion()
  {
    var nomeCampo_fecha_asginacion = "fecha_asginacion";
    var var_fecha_asginacion = scAjaxGetFieldText(nomeCampo_fecha_asginacion);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_fecha_asginacion = scAjaxGetFieldText(nomeCampo_fecha_asginacion);
      x_ajax_f_personal_proyecto_mob_validate_fecha_asginacion(var_fecha_asginacion, var_script_case_init, do_ajax_f_personal_proyecto_mob_validate_fecha_asginacion_cb);
    }, 200);
  } // do_ajax_f_personal_proyecto_mob_validate_fecha_asginacion

  function do_ajax_f_personal_proyecto_mob_validate_fecha_asginacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha_asginacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_personal_proyecto_mob_validate_fecha_asginacion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_f_personal_proyecto_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_f_personal_proyecto_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_personal = scAjaxGetFieldSelect("id_personal");
    var var_id_proyecto = scAjaxGetFieldSelect("id_proyecto");
    var var_fecha_asginacion = scAjaxGetFieldText("fecha_asginacion");
    ...
    scAjaxProcOn();
    x_ajax_f_personal_proyecto_mob_submit_form(var_id_personal, var_id_proyecto, var_fecha_asginacion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_f_personal_proyecto_mob_submit_form_cb);
  } // do_ajax_f_personal_proyecto_mob_submit_form

  function do_ajax_f_personal_proyecto_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_personal");
      scAjaxHideErrorDisplay("id_proyecto");
      scAjaxHideErrorDisplay("fecha_asginacion");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_f_personal_proyecto_mob_submit_form_cb_after_alert);
  } // do_ajax_f_personal_proyecto_mob_submit_form_cb
  function do_ajax_f_personal_proyecto_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_f_personal_proyecto_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_f_personal_proyecto_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("id_proyecto");
    scAjaxHideErrorDisplay("fecha_asginacion");
    var var_id_personal = document.F2.id_personal.value;
    ...
    scAjaxProcOn();
    x_ajax_f_personal_proyecto_mob_navigate_form(var_id_personal, var_id_proyecto, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_f_personal_proyecto_mob_navigate_form_cb);
  } // do_ajax_f_personal_proyecto_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['f_personal_proyecto_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_f_personal_proyecto_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_f_personal_proyecto_mob_form();
    }
    scAjaxClearErrors()
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_personal.value = scAjaxGetKeyValue("id_personal");
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_f_personal_proyecto_mob_navigate_form_cb_after_alert);
  } // do_ajax_f_personal_proyecto_mob_navigate_form_cb
  function do_ajax_f_personal_proyecto_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_f_personal_proyecto_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_f_personal_proyecto_mob_navigate_form_cb_after_alert
  function sc_hide_f_personal_proyecto_mob_form()
  {
  ...
  ajax_field_list[0] = "id_personal";
  ajax_field_list[1] = "id_proyecto";
  ajax_field_list[2] = "fecha_asginacion";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_personal": {"label": "Id Personal", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "fecha_asginacion": {"label": "Fecha Asginacion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "id_personal": new Array(),
    "id_proyecto": new Array(),
    "fecha_asginacion": new Array()
  };
  ajax_field_mult["id_personal"][1] = "id_personal";
  ajax_field_mult["id_proyecto"][1] = "id_proyecto";
  ajax_field_mult["fecha_asginacion"][1] = "fecha_asginacion";

  var ajax_field_id = {
    "id_personal": new Array("hidden_field_label_id_personal", "hidden_field_data_id_personal"),
    "id_proyecto": new Array("hidden_field_label_id_proyecto", "hidden_field_data_id_proyecto"),
    "fecha_asginacion": new Array("hidden_field_label_fecha_asginacion", "hidden_field_data_fecha_asginacion")
  };

  var ajax_read_only = {
    "id_personal": "on",
    "id_proyecto": "on",
    "fecha_asginacion": "off"
  };
