<?php  
  ...
  session_start() ;
  class f_personal_proyecto_form_teste
  {
   function f_personal_proyecto_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "f_personal_proyecto/img";
...
?> 
<br> 
<B><FONT SIZE="4">f_personal_proyecto</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="f_personal_proyecto"> 
</form> 
...
<?php
  ...
  $frm_teste = new f_personal_proyecto_form_teste();
  $frm_teste->f_personal_proyecto_teste();
?>
