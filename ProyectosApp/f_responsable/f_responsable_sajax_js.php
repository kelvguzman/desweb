  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_f_responsable" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_f_responsable_validate_id_responsable()
  {
    ...
    x_ajax_f_responsable_validate_id_responsable(var_id_responsable, var_script_case_init, do_ajax_f_responsable_validate_id_responsable_cb);
  } // do_ajax_f_responsable_validate_id_responsable

  function do_ajax_f_responsable_validate_id_responsable_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_responsable_validate_id_responsable_cb

  // ---------- Validate nombre_responsable
  function do_ajax_f_responsable_validate_nombre_responsable()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_responsable_validate_nombre_responsable(var_nombre_responsable, var_script_case_init, do_ajax_f_responsable_validate_nombre_responsable_cb);
  } // do_ajax_f_responsable_validate_nombre_responsable

  function do_ajax_f_responsable_validate_nombre_responsable_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_responsable_validate_nombre_responsable_cb

  // ---------- Validate tel_responsable
  function do_ajax_f_responsable_validate_tel_responsable()
  {
    var nomeCampo_tel_responsable = "tel_responsable";
    var var_tel_responsable = scAjaxGetFieldText(nomeCampo_tel_responsable);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_responsable_validate_tel_responsable(var_tel_responsable, var_script_case_init, do_ajax_f_responsable_validate_tel_responsable_cb);
  } // do_ajax_f_responsable_validate_tel_responsable

  function do_ajax_f_responsable_validate_tel_responsable_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_responsable_validate_tel_responsable_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_f_responsable_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_f_responsable_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_f_responsable_submit_form(var_id_responsable, var_nombre_responsable, var_tel_responsable, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_f_responsable_submit_form_cb);
  } // do_ajax_f_responsable_submit_form

  function do_ajax_f_responsable_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_f_responsable_submit_form_cb_after_alert);
  } // do_ajax_f_responsable_submit_form_cb
  function do_ajax_f_responsable_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_f_responsable_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_f_responsable_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_f_responsable_navigate_form(var_id_responsable, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_f_responsable_navigate_form_cb);
  } // do_ajax_f_responsable_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['f_responsable']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_f_responsable_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_f_responsable_navigate_form_cb_after_alert);
  } // do_ajax_f_responsable_navigate_form_cb
  function do_ajax_f_responsable_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_f_responsable_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_f_responsable_navigate_form_cb_after_alert
  function sc_hide_f_responsable_form()
  {
