<?php  
  ...
  session_start() ;
  class f_responsable_form_teste
  {
   function f_responsable_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "f_responsable/img";
...
?> 
<br> 
<B><FONT SIZE="4">f_responsable</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="f_responsable"> 
</form> 
...
<?php
  ...
  $frm_teste = new f_responsable_form_teste();
  $frm_teste->f_responsable_teste();
?>
