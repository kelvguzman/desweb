  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_f_responsable_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_f_responsable_mob_validate_id_responsable()
  {
    var nomeCampo_id_responsable = "id_responsable";
    var var_id_responsable = scAjaxGetFieldHidden(nomeCampo_id_responsable);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_responsable_mob_validate_id_responsable(var_id_responsable, var_script_case_init, do_ajax_f_responsable_mob_validate_id_responsable_cb);
  } // do_ajax_f_responsable_mob_validate_id_responsable

  function do_ajax_f_responsable_mob_validate_id_responsable_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_responsable_mob_validate_id_responsable_cb

  // ---------- Validate nombre_responsable
  function do_ajax_f_responsable_mob_validate_nombre_responsable()
  {
    var nomeCampo_nombre_responsable = "nombre_responsable";
    var var_nombre_responsable = scAjaxGetFieldText(nomeCampo_nombre_responsable);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_responsable_mob_validate_nombre_responsable(var_nombre_responsable, var_script_case_init, do_ajax_f_responsable_mob_validate_nombre_responsable_cb);
  } // do_ajax_f_responsable_mob_validate_nombre_responsable

  function do_ajax_f_responsable_mob_validate_nombre_responsable_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre_responsable";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_responsable_mob_validate_nombre_responsable_cb

  // ---------- Validate tel_responsable
  function do_ajax_f_responsable_mob_validate_tel_responsable()
  {
    var nomeCampo_tel_responsable = "tel_responsable";
    var var_tel_responsable = scAjaxGetFieldText(nomeCampo_tel_responsable);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_responsable_mob_validate_tel_responsable(var_tel_responsable, var_script_case_init, do_ajax_f_responsable_mob_validate_tel_responsable_cb);
  } // do_ajax_f_responsable_mob_validate_tel_responsable

  function do_ajax_f_responsable_mob_validate_tel_responsable_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tel_responsable";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_responsable_mob_validate_tel_responsable_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_f_responsable_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_f_responsable_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_responsable = scAjaxGetFieldHidden("id_responsable");
    var var_nombre_responsable = scAjaxGetFieldText("nombre_responsable");
    var var_tel_responsable = scAjaxGetFieldText("tel_responsable");
    ...
    scAjaxProcOn();
    x_ajax_f_responsable_mob_submit_form(var_id_responsable, var_nombre_responsable, var_tel_responsable, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_f_responsable_mob_submit_form_cb);
  } // do_ajax_f_responsable_mob_submit_form

  function do_ajax_f_responsable_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("nombre_responsable");
      scAjaxHideErrorDisplay("tel_responsable");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_f_responsable_mob_submit_form_cb_after_alert);
  } // do_ajax_f_responsable_mob_submit_form_cb
  function do_ajax_f_responsable_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_f_responsable_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_f_responsable_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("nombre_responsable");
    scAjaxHideErrorDisplay("tel_responsable");
    var var_id_responsable = document.F2.id_responsable.value;
    ...
    scAjaxProcOn();
    x_ajax_f_responsable_mob_navigate_form(var_id_responsable, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_f_responsable_mob_navigate_form_cb);
  } // do_ajax_f_responsable_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['f_responsable_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_f_responsable_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_f_responsable_mob_form();
    }
    scAjaxClearErrors()
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_responsable.value = scAjaxGetKeyValue("id_responsable");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_f_responsable_mob_navigate_form_cb_after_alert);
  } // do_ajax_f_responsable_mob_navigate_form_cb
  function do_ajax_f_responsable_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_f_responsable_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_f_responsable_mob_navigate_form_cb_after_alert
  function sc_hide_f_responsable_mob_form()
  {
  ...
  ajax_field_list[0] = "id_responsable";
  ajax_field_list[1] = "nombre_responsable";
  ajax_field_list[2] = "tel_responsable";
  ...
  var ajax_error_list = {
    ...
    "nombre_responsable": {"label": "Nombre Responsable", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tel_responsable": {"label": "Tel Responsable", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "nombre_responsable": new Array(),
    "tel_responsable": new Array()
  };
  ajax_field_mult["id_responsable"][1] = "id_responsable";
  ajax_field_mult["nombre_responsable"][1] = "nombre_responsable";
  ajax_field_mult["tel_responsable"][1] = "tel_responsable";

  var ajax_field_id = {
    "id_responsable": new Array("hidden_field_label_id_responsable", "hidden_field_data_id_responsable"),
    "nombre_responsable": new Array("hidden_field_label_nombre_responsable", "hidden_field_data_nombre_responsable"),
    "tel_responsable": new Array("hidden_field_label_tel_responsable", "hidden_field_data_tel_responsable")
  };

  var ajax_read_only = {
    "id_responsable": "on",
    "nombre_responsable": "off",
    "tel_responsable": "off"
  };
