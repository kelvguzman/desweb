...
//
   ...
   $_SESSION['scriptcase']['app_Login']['glo_nm_path_doc']        = "C:/Program Files/NetMake/v9/wwwrootC:/Program Files/NetMake/v9/wwwroot/scriptcase/file/doc";
   $_SESSION['scriptcase']['app_Login']['glo_nm_conexao']         = "ProyectosApp";
   $NM_dir_atual = getcwd();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'ProyectosApp'); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_Login']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'ProyectosApp', 1, true);
    }
    else {
...
//
    ...
    if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
        if (is_file($root . $_SESSION['scriptcase']['app_Login']['glo_nm_path_imag_temp'] . "/sc_apl_default_ProyectosApp.txt")) {
            $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_Login']['glo_nm_path_imag_temp'] . "/sc_apl_default_ProyectosApp.txt"));
    ...
    if (isset($_SESSION['scriptcase']['app_Login']['session_timeout']['lang'])) {
        $STR_lang = $_SESSION['scriptcase']['app_Login']['session_timeout']['lang'];
    }
    ...
    if (!isset($_SESSION['scriptcase']['app_Login']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) || $_SESSION['scriptcase']['sc_apl_seg']['app_Login'] != "on"))
    { 
        $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
        $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['app_Login']['iframe_menu']) ? false : true;
