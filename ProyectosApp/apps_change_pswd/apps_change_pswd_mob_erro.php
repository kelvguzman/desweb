...
$old_error_handler = set_error_handler("apps_change_pswd_mob_scriptcase_error_handler");

function apps_change_pswd_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['apps_change_pswd_mob']['contr_erro']) && $_SESSION['scriptcase']['apps_change_pswd_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_apps_change_pswd_mob->contr_apps_change_pswd_mob->Apl_com_erro = true;
            if ($inicial_apps_change_pswd_mob->contr_apps_change_pswd_mob->NM_ajax_flag)
            {
                $inicial_apps_change_pswd_mob->contr_apps_change_pswd_mob->NM_ajax_info['errList']['geral_apps_change_pswd_mob'][] = $msg;
                return;
            }
            apps_change_pswd_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function apps_change_pswd_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['apps_change_pswd_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['apps_change_pswd_mob'])  ? $_SESSION['scriptcase']['error_icon']['apps_change_pswd_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['apps_change_pswd_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['apps_change_pswd_mob']) ? $_SESSION['scriptcase']['error_span_title']['apps_change_pswd_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['apps_change_pswd_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['apps_change_pswd_mob']) ? $_SESSION['scriptcase']['error_icon_title']['apps_change_pswd_mob'] : '';
?>
