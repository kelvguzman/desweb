<?php  
  ...
  session_start() ;
  class apps_change_pswd_form_teste
  {
   function apps_change_pswd_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "apps_change_pswd/img";
...
?> 
<br> 
<B><FONT SIZE="4">apps_change_pswd</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="apps_change_pswd"> 
</form> 
...
<?php
  ...
  $frm_teste = new apps_change_pswd_form_teste();
  $frm_teste->apps_change_pswd_teste();
?>
