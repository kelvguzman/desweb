<?php  
  ...
  session_start() ;
  class apps_form_edit_users_form_teste
  {
   function apps_form_edit_users_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "apps_form_edit_users/img";
...
?> 
<br> 
<B><FONT SIZE="4">apps_form_edit_users</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="apps_form_edit_users"> 
</form> 
...
<?php
  ...
  $frm_teste = new apps_form_edit_users_form_teste();
  $frm_teste->apps_form_edit_users_teste();
?>
