<?php  
  ...
  session_start() ;
  class apps_grid_sec_users_groups_form_teste
  {
  function apps_grid_sec_users_groups_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">apps_grid_sec_users_groups</FONT></B> 
<br> 
<br> 
...
<input type=submit value="apps_grid_sec_users_groups"> 
</form> 
...
<?php
  ...
  $frm_teste = new apps_grid_sec_users_groups_form_teste();
  $frm_teste->apps_grid_sec_users_groups_teste();
?>
