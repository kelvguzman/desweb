<?php  
  ...
  session_start() ;
  class apps_Login_form_teste
  {
   function apps_Login_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "apps_Login/img";
...
?> 
<br> 
<B><FONT SIZE="4">apps_Login</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="apps_Login"> 
</form> 
...
<?php
  ...
  $frm_teste = new apps_Login_form_teste();
  $frm_teste->apps_Login_teste();
?>
