...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_login' + iSeqRow).bind('blur', function() { sc_apps_Login_login_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_apps_Login_login_onfocus(this, iSeqRow) });
  $('#id_sc_field_pswd' + iSeqRow).bind('blur', function() { sc_apps_Login_pswd_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_apps_Login_pswd_onfocus(this, iSeqRow) });
  $('#id_sc_field_links' + iSeqRow).bind('blur', function() { sc_apps_Login_links_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_apps_Login_links_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_apps_Login_login_onblur(oThis, iSeqRow) {
  do_ajax_apps_Login_mob_validate_login();
  scCssBlur(oThis);
}

function sc_apps_Login_login_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_apps_Login_pswd_onblur(oThis, iSeqRow) {
  do_ajax_apps_Login_mob_validate_pswd();
  scCssBlur(oThis);
}

function sc_apps_Login_pswd_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_apps_Login_links_onblur(oThis, iSeqRow) {
  do_ajax_apps_Login_mob_validate_links();
  scCssBlur(oThis);
}

function sc_apps_Login_links_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_apps_Login_mob_form" + pageNo).hide();
}
