  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_f_personal_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_f_personal_mob_validate_id_personal()
  {
    var nomeCampo_id_personal = "id_personal";
    var var_id_personal = scAjaxGetFieldHidden(nomeCampo_id_personal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_personal_mob_validate_id_personal(var_id_personal, var_script_case_init, do_ajax_f_personal_mob_validate_id_personal_cb);
  } // do_ajax_f_personal_mob_validate_id_personal

  function do_ajax_f_personal_mob_validate_id_personal_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_personal_mob_validate_id_personal_cb

  // ---------- Validate nombre_completo
  function do_ajax_f_personal_mob_validate_nombre_completo()
  {
    var nomeCampo_nombre_completo = "nombre_completo";
    var var_nombre_completo = scAjaxGetFieldText(nomeCampo_nombre_completo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_personal_mob_validate_nombre_completo(var_nombre_completo, var_script_case_init, do_ajax_f_personal_mob_validate_nombre_completo_cb);
  } // do_ajax_f_personal_mob_validate_nombre_completo

  function do_ajax_f_personal_mob_validate_nombre_completo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre_completo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_personal_mob_validate_nombre_completo_cb

  // ---------- Validate habilidad
  function do_ajax_f_personal_mob_validate_habilidad()
  {
    var nomeCampo_habilidad = "habilidad";
    var var_habilidad = scAjaxGetFieldText(nomeCampo_habilidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_personal_mob_validate_habilidad(var_habilidad, var_script_case_init, do_ajax_f_personal_mob_validate_habilidad_cb);
  } // do_ajax_f_personal_mob_validate_habilidad

  function do_ajax_f_personal_mob_validate_habilidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "habilidad";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_personal_mob_validate_habilidad_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_f_personal_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_f_personal_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_personal = scAjaxGetFieldHidden("id_personal");
    var var_nombre_completo = scAjaxGetFieldText("nombre_completo");
    var var_habilidad = scAjaxGetFieldText("habilidad");
    ...
    scAjaxProcOn();
    x_ajax_f_personal_mob_submit_form(var_id_personal, var_nombre_completo, var_habilidad, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_f_personal_mob_submit_form_cb);
  } // do_ajax_f_personal_mob_submit_form

  function do_ajax_f_personal_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("nombre_completo");
      scAjaxHideErrorDisplay("habilidad");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_f_personal_mob_submit_form_cb_after_alert);
  } // do_ajax_f_personal_mob_submit_form_cb
  function do_ajax_f_personal_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_f_personal_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_f_personal_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_f_personal_mob_navigate_form(var_id_personal, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_f_personal_mob_navigate_form_cb);
  } // do_ajax_f_personal_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['f_personal_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_f_personal_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_f_personal_mob_navigate_form_cb_after_alert);
  } // do_ajax_f_personal_mob_navigate_form_cb
  function do_ajax_f_personal_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_f_personal_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_f_personal_mob_navigate_form_cb_after_alert
  function sc_hide_f_personal_mob_form()
  {
  ...
  ajax_field_list[1] = "nombre_completo";
  ajax_field_list[2] = "habilidad";
  ...
  var ajax_error_list = {
    ...
    "nombre_completo": {"label": "Nombre Completo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "habilidad": {"label": "Habilidad", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "nombre_completo": new Array(),
    "habilidad": new Array()
  };
  ajax_field_mult["id_personal"][1] = "id_personal";
  ajax_field_mult["nombre_completo"][1] = "nombre_completo";
  ajax_field_mult["habilidad"][1] = "habilidad";

  var ajax_field_id = {
    "id_personal": new Array("hidden_field_label_id_personal", "hidden_field_data_id_personal"),
    "nombre_completo": new Array("hidden_field_label_nombre_completo", "hidden_field_data_nombre_completo"),
    "habilidad": new Array("hidden_field_label_habilidad", "hidden_field_data_habilidad")
  };
