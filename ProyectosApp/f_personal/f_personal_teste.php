<?php  
  ...
  session_start() ;
  class f_personal_form_teste
  {
   function f_personal_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "f_personal/img";
...
?> 
<br> 
<B><FONT SIZE="4">f_personal</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="f_personal"> 
</form> 
...
<?php
  ...
  $frm_teste = new f_personal_form_teste();
  $frm_teste->f_personal_teste();
?>
