<?php  
  ...
  session_start() ;
  class apps_form_sec_groups_form_teste
  {
   function apps_form_sec_groups_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "apps_form_sec_groups/img";
...
?> 
<br> 
<B><FONT SIZE="4">apps_form_sec_groups</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="apps_form_sec_groups"> 
</form> 
...
<?php
  ...
  $frm_teste = new apps_form_sec_groups_form_teste();
  $frm_teste->apps_form_sec_groups_teste();
?>
