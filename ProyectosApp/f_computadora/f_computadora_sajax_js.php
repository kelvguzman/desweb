  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_f_computadora" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_f_computadora_validate_id_computadora()
  {
    ...
    x_ajax_f_computadora_validate_id_computadora(var_id_computadora, var_script_case_init, do_ajax_f_computadora_validate_id_computadora_cb);
  } // do_ajax_f_computadora_validate_id_computadora

  function do_ajax_f_computadora_validate_id_computadora_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_computadora_validate_id_computadora_cb

  // ---------- Validate marca
  function do_ajax_f_computadora_validate_marca()
  {
    var nomeCampo_marca = "marca";
    var var_marca = scAjaxGetFieldText(nomeCampo_marca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_computadora_validate_marca(var_marca, var_script_case_init, do_ajax_f_computadora_validate_marca_cb);
  } // do_ajax_f_computadora_validate_marca

  function do_ajax_f_computadora_validate_marca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "marca";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_computadora_validate_marca_cb

  // ---------- Validate modelo
  function do_ajax_f_computadora_validate_modelo()
  {
    var nomeCampo_modelo = "modelo";
    var var_modelo = scAjaxGetFieldText(nomeCampo_modelo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_computadora_validate_modelo(var_modelo, var_script_case_init, do_ajax_f_computadora_validate_modelo_cb);
  } // do_ajax_f_computadora_validate_modelo

  function do_ajax_f_computadora_validate_modelo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "modelo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_computadora_validate_modelo_cb

  // ---------- Validate memoria_gb
  function do_ajax_f_computadora_validate_memoria_gb()
  {
    var nomeCampo_memoria_gb = "memoria_gb";
    var var_memoria_gb = scAjaxGetFieldText(nomeCampo_memoria_gb);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_computadora_validate_memoria_gb(var_memoria_gb, var_script_case_init, do_ajax_f_computadora_validate_memoria_gb_cb);
  } // do_ajax_f_computadora_validate_memoria_gb

  function do_ajax_f_computadora_validate_memoria_gb_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_computadora_validate_memoria_gb_cb

  // ---------- Validate almacenamiento_gb
  function do_ajax_f_computadora_validate_almacenamiento_gb()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_computadora_validate_almacenamiento_gb(var_almacenamiento_gb, var_script_case_init, do_ajax_f_computadora_validate_almacenamiento_gb_cb);
  } // do_ajax_f_computadora_validate_almacenamiento_gb

  function do_ajax_f_computadora_validate_almacenamiento_gb_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_computadora_validate_almacenamiento_gb_cb

  // ---------- Validate id_tipocomputadora
  function do_ajax_f_computadora_validate_id_tipocomputadora()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_computadora_validate_id_tipocomputadora(var_id_tipocomputadora, var_script_case_init, do_ajax_f_computadora_validate_id_tipocomputadora_cb);
  } // do_ajax_f_computadora_validate_id_tipocomputadora

  function do_ajax_f_computadora_validate_id_tipocomputadora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_computadora_validate_id_tipocomputadora_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_f_computadora_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_f_computadora_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_f_computadora_submit_form(var_id_computadora, var_marca, var_modelo, var_memoria_gb, var_almacenamiento_gb, var_id_tipocomputadora, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_f_computadora_submit_form_cb);
  } // do_ajax_f_computadora_submit_form

  function do_ajax_f_computadora_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_f_computadora_submit_form_cb_after_alert);
  } // do_ajax_f_computadora_submit_form_cb
  function do_ajax_f_computadora_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_f_computadora_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_f_computadora_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_f_computadora_navigate_form(var_id_computadora, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_f_computadora_navigate_form_cb);
  } // do_ajax_f_computadora_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['f_computadora']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_f_computadora_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_f_computadora_navigate_form_cb_after_alert);
  } // do_ajax_f_computadora_navigate_form_cb
  function do_ajax_f_computadora_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_f_computadora_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_f_computadora_navigate_form_cb_after_alert
  function sc_hide_f_computadora_form()
  {
