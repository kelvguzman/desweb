  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_f_computadora_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_computadora
  function do_ajax_f_computadora_mob_validate_id_computadora()
  {
    var nomeCampo_id_computadora = "id_computadora";
    var var_id_computadora = scAjaxGetFieldHidden(nomeCampo_id_computadora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_computadora_mob_validate_id_computadora(var_id_computadora, var_script_case_init, do_ajax_f_computadora_mob_validate_id_computadora_cb);
  } // do_ajax_f_computadora_mob_validate_id_computadora

  function do_ajax_f_computadora_mob_validate_id_computadora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_computadora";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_computadora_mob_validate_id_computadora_cb

  // ---------- Validate marca
  function do_ajax_f_computadora_mob_validate_marca()
  {
    var nomeCampo_marca = "marca";
    var var_marca = scAjaxGetFieldText(nomeCampo_marca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_computadora_mob_validate_marca(var_marca, var_script_case_init, do_ajax_f_computadora_mob_validate_marca_cb);
  } // do_ajax_f_computadora_mob_validate_marca

  function do_ajax_f_computadora_mob_validate_marca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "marca";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_computadora_mob_validate_marca_cb

  // ---------- Validate modelo
  function do_ajax_f_computadora_mob_validate_modelo()
  {
    var nomeCampo_modelo = "modelo";
    var var_modelo = scAjaxGetFieldText(nomeCampo_modelo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_computadora_mob_validate_modelo(var_modelo, var_script_case_init, do_ajax_f_computadora_mob_validate_modelo_cb);
  } // do_ajax_f_computadora_mob_validate_modelo

  function do_ajax_f_computadora_mob_validate_modelo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "modelo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_computadora_mob_validate_modelo_cb

  // ---------- Validate memoria_gb
  function do_ajax_f_computadora_mob_validate_memoria_gb()
  {
    var nomeCampo_memoria_gb = "memoria_gb";
    var var_memoria_gb = scAjaxGetFieldText(nomeCampo_memoria_gb);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_computadora_mob_validate_memoria_gb(var_memoria_gb, var_script_case_init, do_ajax_f_computadora_mob_validate_memoria_gb_cb);
  } // do_ajax_f_computadora_mob_validate_memoria_gb

  function do_ajax_f_computadora_mob_validate_memoria_gb_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "memoria_gb";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_computadora_mob_validate_memoria_gb_cb

  // ---------- Validate almacenamiento_gb
  function do_ajax_f_computadora_mob_validate_almacenamiento_gb()
  {
    var nomeCampo_almacenamiento_gb = "almacenamiento_gb";
    var var_almacenamiento_gb = scAjaxGetFieldText(nomeCampo_almacenamiento_gb);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_computadora_mob_validate_almacenamiento_gb(var_almacenamiento_gb, var_script_case_init, do_ajax_f_computadora_mob_validate_almacenamiento_gb_cb);
  } // do_ajax_f_computadora_mob_validate_almacenamiento_gb

  function do_ajax_f_computadora_mob_validate_almacenamiento_gb_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "almacenamiento_gb";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_computadora_mob_validate_almacenamiento_gb_cb

  // ---------- Validate id_tipocomputadora
  function do_ajax_f_computadora_mob_validate_id_tipocomputadora()
  {
    var nomeCampo_id_tipocomputadora = "id_tipocomputadora";
    var var_id_tipocomputadora = scAjaxGetFieldSelect(nomeCampo_id_tipocomputadora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_computadora_mob_validate_id_tipocomputadora(var_id_tipocomputadora, var_script_case_init, do_ajax_f_computadora_mob_validate_id_tipocomputadora_cb);
  } // do_ajax_f_computadora_mob_validate_id_tipocomputadora

  function do_ajax_f_computadora_mob_validate_id_tipocomputadora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_tipocomputadora";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_computadora_mob_validate_id_tipocomputadora_cb
...
function scJs_sweetalert_params(params) {
	...
	confirmText = '<?php echo $this->Ini->Nm_lang['lang_btns_cfrm'] ?>';
	confirmFA = '<?php echo $confirmButtonFA ?>';
	confirmPos = '<?php echo $confirmButtonFAPos ?>';
	cancelText = '<?php echo $this->Ini->Nm_lang['lang_btns_cncl'] ?>';
  ...
  // ---------- Form
  function do_ajax_f_computadora_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_f_computadora_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_computadora = scAjaxGetFieldHidden("id_computadora");
    var var_marca = scAjaxGetFieldText("marca");
    var var_modelo = scAjaxGetFieldText("modelo");
    var var_memoria_gb = scAjaxGetFieldText("memoria_gb");
    var var_almacenamiento_gb = scAjaxGetFieldText("almacenamiento_gb");
    var var_id_tipocomputadora = scAjaxGetFieldSelect("id_tipocomputadora");
    ...
    scAjaxProcOn();
    x_ajax_f_computadora_mob_submit_form(var_id_computadora, var_marca, var_modelo, var_memoria_gb, var_almacenamiento_gb, var_id_tipocomputadora, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_f_computadora_mob_submit_form_cb);
  } // do_ajax_f_computadora_mob_submit_form

  function do_ajax_f_computadora_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_computadora");
      scAjaxHideErrorDisplay("marca");
      scAjaxHideErrorDisplay("modelo");
      scAjaxHideErrorDisplay("memoria_gb");
      scAjaxHideErrorDisplay("almacenamiento_gb");
      scAjaxHideErrorDisplay("id_tipocomputadora");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_f_computadora_mob_submit_form_cb_after_alert);
  } // do_ajax_f_computadora_mob_submit_form_cb
  function do_ajax_f_computadora_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_f_computadora_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_f_computadora_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("almacenamiento_gb");
    scAjaxHideErrorDisplay("id_tipocomputadora");
    var var_id_computadora = document.F2.id_computadora.value;
    ...
    scAjaxProcOn();
    x_ajax_f_computadora_mob_navigate_form(var_id_computadora, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_f_computadora_mob_navigate_form_cb);
  } // do_ajax_f_computadora_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['f_computadora_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_f_computadora_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_f_computadora_mob_form();
    }
    scAjaxClearErrors()
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_computadora.value = scAjaxGetKeyValue("id_computadora");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_f_computadora_mob_navigate_form_cb_after_alert);
  } // do_ajax_f_computadora_mob_navigate_form_cb
  function do_ajax_f_computadora_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_f_computadora_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_f_computadora_mob_navigate_form_cb_after_alert
  function sc_hide_f_computadora_mob_form()
  {
  ...
  ajax_field_list[0] = "id_computadora";
  ajax_field_list[1] = "marca";
  ajax_field_list[2] = "modelo";
  ajax_field_list[3] = "memoria_gb";
  ajax_field_list[4] = "almacenamiento_gb";
  ajax_field_list[5] = "id_tipocomputadora";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_computadora": {"label": "Id Computadora", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "memoria_gb": {"label": "Memoria GB", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "almacenamiento_gb": {"label": "Almacenamiento GB", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_tipocomputadora": {"label": "Id Tipocomputadora", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "id_computadora": new Array(),
    "marca": new Array(),
    "modelo": new Array(),
    "memoria_gb": new Array(),
    "almacenamiento_gb": new Array(),
    "id_tipocomputadora": new Array()
  };
  ajax_field_mult["id_computadora"][1] = "id_computadora";
  ajax_field_mult["marca"][1] = "marca";
  ajax_field_mult["modelo"][1] = "modelo";
  ajax_field_mult["memoria_gb"][1] = "memoria_gb";
  ajax_field_mult["almacenamiento_gb"][1] = "almacenamiento_gb";
  ajax_field_mult["id_tipocomputadora"][1] = "id_tipocomputadora";

  var ajax_field_id = {
    "id_computadora": new Array("hidden_field_label_id_computadora", "hidden_field_data_id_computadora"),
    ...
    "memoria_gb": new Array("hidden_field_label_memoria_gb", "hidden_field_data_memoria_gb"),
    "almacenamiento_gb": new Array("hidden_field_label_almacenamiento_gb", "hidden_field_data_almacenamiento_gb"),
    "id_tipocomputadora": new Array("hidden_field_label_id_tipocomputadora", "hidden_field_data_id_tipocomputadora")
  };
  ...
  var ajax_read_only = {
    ...
    "modelo": "off",
    "memoria_gb": "off",
    "almacenamiento_gb": "off",
    "id_tipocomputadora": "off"
  };
