<?php  
  ...
  session_start() ;
  class f_computadora_form_teste
  {
   function f_computadora_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "f_computadora/img";
...
?> 
<br> 
<B><FONT SIZE="4">f_computadora</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="f_computadora"> 
</form> 
...
<?php
  ...
  $frm_teste = new f_computadora_form_teste();
  $frm_teste->f_computadora_teste();
?>
