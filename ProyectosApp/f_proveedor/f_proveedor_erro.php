...
$old_error_handler = set_error_handler("f_proveedor_scriptcase_error_handler");

function f_proveedor_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['f_proveedor']['contr_erro']) && $_SESSION['scriptcase']['f_proveedor']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_f_proveedor->contr_f_proveedor->Apl_com_erro = true;
            if ($inicial_f_proveedor->contr_f_proveedor->NM_ajax_flag)
            {
                $inicial_f_proveedor->contr_f_proveedor->NM_ajax_info['errList']['geral_f_proveedor'][] = $msg;
                return;
            }
            f_proveedor_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function f_proveedor_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['f_proveedor'])  && '' != $_SESSION['scriptcase']['error_icon']['f_proveedor'])  ? $_SESSION['scriptcase']['error_icon']['f_proveedor']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['f_proveedor']) && '' != $_SESSION['scriptcase']['error_close']['f_proveedor']) ? $_SESSION['scriptcase']['error_close']['f_proveedor'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['f_proveedor']) && '' != $_SESSION['scriptcase']['error_span_title']['f_proveedor']) ? $_SESSION['scriptcase']['error_span_title']['f_proveedor'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['f_proveedor']) && '' != $_SESSION['scriptcase']['error_icon_title']['f_proveedor']) ? $_SESSION['scriptcase']['error_icon_title']['f_proveedor'] : '';
?>
