  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_f_proveedor_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_f_proveedor_mob_validate_id_proveedor()
  {
    var nomeCampo_id_proveedor = "id_proveedor";
    var var_id_proveedor = scAjaxGetFieldText(nomeCampo_id_proveedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_proveedor_mob_validate_id_proveedor(var_id_proveedor, var_script_case_init, do_ajax_f_proveedor_mob_validate_id_proveedor_cb);
  } // do_ajax_f_proveedor_mob_validate_id_proveedor

  function do_ajax_f_proveedor_mob_validate_id_proveedor_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_proveedor_mob_validate_id_proveedor_cb

  // ---------- Validate empresa
  function do_ajax_f_proveedor_mob_validate_empresa()
  {
    var nomeCampo_empresa = "empresa";
    var var_empresa = scAjaxGetFieldText(nomeCampo_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_proveedor_mob_validate_empresa(var_empresa, var_script_case_init, do_ajax_f_proveedor_mob_validate_empresa_cb);
  } // do_ajax_f_proveedor_mob_validate_empresa

  function do_ajax_f_proveedor_mob_validate_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "empresa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_proveedor_mob_validate_empresa_cb

  // ---------- Validate nombre_contacto
  function do_ajax_f_proveedor_mob_validate_nombre_contacto()
  {
    var nomeCampo_nombre_contacto = "nombre_contacto";
    var var_nombre_contacto = scAjaxGetFieldText(nomeCampo_nombre_contacto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_proveedor_mob_validate_nombre_contacto(var_nombre_contacto, var_script_case_init, do_ajax_f_proveedor_mob_validate_nombre_contacto_cb);
  } // do_ajax_f_proveedor_mob_validate_nombre_contacto

  function do_ajax_f_proveedor_mob_validate_nombre_contacto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre_contacto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_proveedor_mob_validate_nombre_contacto_cb

  // ---------- Validate telefono
  function do_ajax_f_proveedor_mob_validate_telefono()
  {
    var nomeCampo_telefono = "telefono";
    var var_telefono = scAjaxGetFieldText(nomeCampo_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_proveedor_mob_validate_telefono(var_telefono, var_script_case_init, do_ajax_f_proveedor_mob_validate_telefono_cb);
  } // do_ajax_f_proveedor_mob_validate_telefono

  function do_ajax_f_proveedor_mob_validate_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_proveedor_mob_validate_telefono_cb

  // ---------- Validate correo_electronico
  function do_ajax_f_proveedor_mob_validate_correo_electronico()
  {
    var nomeCampo_correo_electronico = "correo_electronico";
    var var_correo_electronico = scAjaxGetFieldText(nomeCampo_correo_electronico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_proveedor_mob_validate_correo_electronico(var_correo_electronico, var_script_case_init, do_ajax_f_proveedor_mob_validate_correo_electronico_cb);
  } // do_ajax_f_proveedor_mob_validate_correo_electronico

  function do_ajax_f_proveedor_mob_validate_correo_electronico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "correo_electronico";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_proveedor_mob_validate_correo_electronico_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_f_proveedor_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_f_proveedor_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_proveedor = scAjaxGetFieldText("id_proveedor");
    var var_empresa = scAjaxGetFieldText("empresa");
    var var_nombre_contacto = scAjaxGetFieldText("nombre_contacto");
    var var_telefono = scAjaxGetFieldText("telefono");
    var var_correo_electronico = scAjaxGetFieldText("correo_electronico");
    ...
    scAjaxProcOn();
    x_ajax_f_proveedor_mob_submit_form(var_id_proveedor, var_empresa, var_nombre_contacto, var_telefono, var_correo_electronico, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_f_proveedor_mob_submit_form_cb);
  } // do_ajax_f_proveedor_mob_submit_form

  function do_ajax_f_proveedor_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("nombre_contacto");
      scAjaxHideErrorDisplay("telefono");
      scAjaxHideErrorDisplay("correo_electronico");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_f_proveedor_mob_submit_form_cb_after_alert);
  } // do_ajax_f_proveedor_mob_submit_form_cb
  function do_ajax_f_proveedor_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_f_proveedor_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_f_proveedor_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_f_proveedor_mob_navigate_form(var_id_proveedor, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_f_proveedor_mob_navigate_form_cb);
  } // do_ajax_f_proveedor_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['f_proveedor_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_f_proveedor_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_f_proveedor_mob_navigate_form_cb_after_alert);
  } // do_ajax_f_proveedor_mob_navigate_form_cb
  function do_ajax_f_proveedor_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_f_proveedor_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_f_proveedor_mob_navigate_form_cb_after_alert
  function sc_hide_f_proveedor_mob_form()
  {
  ...
  ajax_field_list[1] = "empresa";
  ajax_field_list[2] = "nombre_contacto";
  ajax_field_list[3] = "telefono";
  ajax_field_list[4] = "correo_electronico";
  ...
  var ajax_error_list = {
    ...
    "nombre_contacto": {"label": "Nombre Contacto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "correo_electronico": {"label": "Correo Electronico", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "empresa": new Array(),
    "nombre_contacto": new Array(),
    "telefono": new Array(),
    "correo_electronico": new Array()
  };
  ajax_field_mult["id_proveedor"][1] = "id_proveedor";
  ajax_field_mult["empresa"][1] = "empresa";
  ajax_field_mult["nombre_contacto"][1] = "nombre_contacto";
  ajax_field_mult["telefono"][1] = "telefono";
  ajax_field_mult["correo_electronico"][1] = "correo_electronico";
  ...
  var ajax_field_id = {
    ...
    "nombre_contacto": new Array("hidden_field_label_nombre_contacto", "hidden_field_data_nombre_contacto"),
    "telefono": new Array("hidden_field_label_telefono", "hidden_field_data_telefono"),
    "correo_electronico": new Array("hidden_field_label_correo_electronico", "hidden_field_data_correo_electronico")
  };
