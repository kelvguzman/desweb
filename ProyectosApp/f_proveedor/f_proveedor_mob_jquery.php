...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_proveedor' + iSeqRow).bind('blur', function() { sc_f_proveedor_id_proveedor_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_f_proveedor_id_proveedor_onfocus(this, iSeqRow) });
  $('#id_sc_field_empresa' + iSeqRow).bind('blur', function() { sc_f_proveedor_empresa_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_f_proveedor_empresa_onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre_contacto' + iSeqRow).bind('blur', function() { sc_f_proveedor_nombre_contacto_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_f_proveedor_nombre_contacto_onfocus(this, iSeqRow) });
  $('#id_sc_field_telefono' + iSeqRow).bind('blur', function() { sc_f_proveedor_telefono_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_f_proveedor_telefono_onfocus(this, iSeqRow) });
  $('#id_sc_field_correo_electronico' + iSeqRow).bind('blur', function() { sc_f_proveedor_correo_electronico_onblur(this, iSeqRow) })
                                                .bind('focus', function() { sc_f_proveedor_correo_electronico_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_f_proveedor_id_proveedor_onblur(oThis, iSeqRow) {
  do_ajax_f_proveedor_mob_validate_id_proveedor();
  scCssBlur(oThis);
}

function sc_f_proveedor_id_proveedor_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_f_proveedor_empresa_onblur(oThis, iSeqRow) {
  do_ajax_f_proveedor_mob_validate_empresa();
  scCssBlur(oThis);
}

function sc_f_proveedor_empresa_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_f_proveedor_nombre_contacto_onblur(oThis, iSeqRow) {
  do_ajax_f_proveedor_mob_validate_nombre_contacto();
  scCssBlur(oThis);
}

function sc_f_proveedor_nombre_contacto_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_f_proveedor_telefono_onblur(oThis, iSeqRow) {
  do_ajax_f_proveedor_mob_validate_telefono();
  scCssBlur(oThis);
}

function sc_f_proveedor_telefono_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_f_proveedor_correo_electronico_onblur(oThis, iSeqRow) {
  do_ajax_f_proveedor_mob_validate_correo_electronico();
  scCssBlur(oThis);
}

function sc_f_proveedor_correo_electronico_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_f_proveedor_mob_form" + pageNo).hide();
}
