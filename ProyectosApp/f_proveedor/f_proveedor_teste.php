<?php  
  ...
  session_start() ;
  class f_proveedor_form_teste
  {
   function f_proveedor_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "f_proveedor/img";
...
?> 
<br> 
<B><FONT SIZE="4">f_proveedor</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="f_proveedor"> 
</form> 
...
<?php
  ...
  $frm_teste = new f_proveedor_form_teste();
  $frm_teste->f_proveedor_teste();
?>
