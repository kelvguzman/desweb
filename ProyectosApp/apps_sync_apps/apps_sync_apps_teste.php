<?php  
  ...
  session_start() ;
  class apps_sync_apps_form_teste
  {
   function apps_sync_apps_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "apps_sync_apps/img";
...
?> 
<br> 
<B><FONT SIZE="4">apps_sync_apps</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="apps_sync_apps"> 
</form> 
...
<?php
  ...
  $frm_teste = new apps_sync_apps_form_teste();
  $frm_teste->apps_sync_apps_teste();
?>
