<?php  
  ...
  session_start() ;
  class f_tipocomputadora_form_teste
  {
   function f_tipocomputadora_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "f_tipocomputadora/img";
...
?> 
<br> 
<B><FONT SIZE="4">f_tipocomputadora</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="f_tipocomputadora"> 
</form> 
...
<?php
  ...
  $frm_teste = new f_tipocomputadora_form_teste();
  $frm_teste->f_tipocomputadora_teste();
?>
