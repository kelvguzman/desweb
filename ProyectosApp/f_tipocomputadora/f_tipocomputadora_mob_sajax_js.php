  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_f_tipocomputadora_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_f_tipocomputadora_mob_validate_id_tipocomputadora()
  {
    var nomeCampo_id_tipocomputadora = "id_tipocomputadora";
    var var_id_tipocomputadora = scAjaxGetFieldHidden(nomeCampo_id_tipocomputadora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_tipocomputadora_mob_validate_id_tipocomputadora(var_id_tipocomputadora, var_script_case_init, do_ajax_f_tipocomputadora_mob_validate_id_tipocomputadora_cb);
  } // do_ajax_f_tipocomputadora_mob_validate_id_tipocomputadora

  function do_ajax_f_tipocomputadora_mob_validate_id_tipocomputadora_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_tipocomputadora_mob_validate_id_tipocomputadora_cb

  // ---------- Validate descripcion_tipo
  function do_ajax_f_tipocomputadora_mob_validate_descripcion_tipo()
  {
    var nomeCampo_descripcion_tipo = "descripcion_tipo";
    var var_descripcion_tipo = scAjaxGetFieldText(nomeCampo_descripcion_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_tipocomputadora_mob_validate_descripcion_tipo(var_descripcion_tipo, var_script_case_init, do_ajax_f_tipocomputadora_mob_validate_descripcion_tipo_cb);
  } // do_ajax_f_tipocomputadora_mob_validate_descripcion_tipo

  function do_ajax_f_tipocomputadora_mob_validate_descripcion_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "descripcion_tipo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_tipocomputadora_mob_validate_descripcion_tipo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_f_tipocomputadora_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_f_tipocomputadora_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_tipocomputadora = scAjaxGetFieldHidden("id_tipocomputadora");
    var var_descripcion_tipo = scAjaxGetFieldText("descripcion_tipo");
    ...
    scAjaxProcOn();
    x_ajax_f_tipocomputadora_mob_submit_form(var_id_tipocomputadora, var_descripcion_tipo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_f_tipocomputadora_mob_submit_form_cb);
  } // do_ajax_f_tipocomputadora_mob_submit_form

  function do_ajax_f_tipocomputadora_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("descripcion_tipo");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_f_tipocomputadora_mob_submit_form_cb_after_alert);
  } // do_ajax_f_tipocomputadora_mob_submit_form_cb
  function do_ajax_f_tipocomputadora_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_f_tipocomputadora_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_f_tipocomputadora_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("id_tipocomputadora");
    scAjaxHideErrorDisplay("descripcion_tipo");
    var var_id_tipocomputadora = document.F2.id_tipocomputadora.value;
    ...
    scAjaxProcOn();
    x_ajax_f_tipocomputadora_mob_navigate_form(var_id_tipocomputadora, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_f_tipocomputadora_mob_navigate_form_cb);
  } // do_ajax_f_tipocomputadora_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['f_tipocomputadora_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_f_tipocomputadora_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_f_tipocomputadora_mob_form();
    }
    scAjaxClearErrors()
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_tipocomputadora.value = scAjaxGetKeyValue("id_tipocomputadora");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_f_tipocomputadora_mob_navigate_form_cb_after_alert);
  } // do_ajax_f_tipocomputadora_mob_navigate_form_cb
  function do_ajax_f_tipocomputadora_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_f_tipocomputadora_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_f_tipocomputadora_mob_navigate_form_cb_after_alert
  function sc_hide_f_tipocomputadora_mob_form()
  {
  ...
  ajax_field_list[0] = "id_tipocomputadora";
  ajax_field_list[1] = "descripcion_tipo";
  ...
  var ajax_error_list = {
    ...
    "descripcion_tipo": {"label": "Descripcion Tipo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "descripcion_tipo": new Array()
  };
  ajax_field_mult["id_tipocomputadora"][1] = "id_tipocomputadora";
  ajax_field_mult["descripcion_tipo"][1] = "descripcion_tipo";

  var ajax_field_id = {
    "id_tipocomputadora": new Array("hidden_field_label_id_tipocomputadora", "hidden_field_data_id_tipocomputadora"),
    "descripcion_tipo": new Array("hidden_field_label_descripcion_tipo", "hidden_field_data_descripcion_tipo")
  };

  var ajax_read_only = {
    "id_tipocomputadora": "on",
    "descripcion_tipo": "off"
  };
