<?php  
  ...
  session_start() ;
  class apps_search_sec_groups_form_teste
  {
  function apps_search_sec_groups_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">apps_search_sec_groups</FONT></B> 
<br> 
<br> 
...
<input type=submit value="apps_search_sec_groups"> 
</form> 
...
<?php
  ...
  $frm_teste = new apps_search_sec_groups_form_teste();
  $frm_teste->apps_search_sec_groups_teste();
?>
