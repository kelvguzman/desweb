<?php  
  ...
  session_start() ;
  class f_categoria_form_teste
  {
   function f_categoria_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "f_categoria/img";
...
?> 
<br> 
<B><FONT SIZE="4">f_categoria</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="f_categoria"> 
</form> 
...
<?php
  ...
  $frm_teste = new f_categoria_form_teste();
  $frm_teste->f_categoria_teste();
?>
