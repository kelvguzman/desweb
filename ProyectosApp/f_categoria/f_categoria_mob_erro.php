...
$old_error_handler = set_error_handler("f_categoria_mob_scriptcase_error_handler");

function f_categoria_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['f_categoria_mob']['contr_erro']) && $_SESSION['scriptcase']['f_categoria_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_f_categoria_mob->contr_f_categoria_mob->Apl_com_erro = true;
            if ($inicial_f_categoria_mob->contr_f_categoria_mob->NM_ajax_flag)
            {
                $inicial_f_categoria_mob->contr_f_categoria_mob->NM_ajax_info['errList']['geral_f_categoria_mob'][] = $msg;
                return;
            }
            f_categoria_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function f_categoria_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['f_categoria_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['f_categoria_mob'])  ? $_SESSION['scriptcase']['error_icon']['f_categoria_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['f_categoria_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['f_categoria_mob']) ? $_SESSION['scriptcase']['error_span_title']['f_categoria_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['f_categoria_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['f_categoria_mob']) ? $_SESSION['scriptcase']['error_icon_title']['f_categoria_mob'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['f_categoria']['error_buffer'] .= ob_get_flush();
}
