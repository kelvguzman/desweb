<?php  
  ...
  session_start() ;
  class f_estatus_proyecto_form_teste
  {
   function f_estatus_proyecto_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "f_estatus_proyecto/img";
...
?> 
<br> 
<B><FONT SIZE="4">f_estatus_proyecto</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="f_estatus_proyecto"> 
</form> 
...
<?php
  ...
  $frm_teste = new f_estatus_proyecto_form_teste();
  $frm_teste->f_estatus_proyecto_teste();
?>
