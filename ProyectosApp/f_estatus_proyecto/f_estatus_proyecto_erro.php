...
$old_error_handler = set_error_handler("f_estatus_proyecto_scriptcase_error_handler");

function f_estatus_proyecto_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['f_estatus_proyecto']['contr_erro']) && $_SESSION['scriptcase']['f_estatus_proyecto']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_f_estatus_proyecto->contr_f_estatus_proyecto->Apl_com_erro = true;
            if ($inicial_f_estatus_proyecto->contr_f_estatus_proyecto->NM_ajax_flag)
            {
                $inicial_f_estatus_proyecto->contr_f_estatus_proyecto->NM_ajax_info['errList']['geral_f_estatus_proyecto'][] = $msg;
                return;
            }
            f_estatus_proyecto_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function f_estatus_proyecto_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['f_estatus_proyecto'])  && '' != $_SESSION['scriptcase']['error_icon']['f_estatus_proyecto'])  ? $_SESSION['scriptcase']['error_icon']['f_estatus_proyecto']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['f_estatus_proyecto']) && '' != $_SESSION['scriptcase']['error_span_title']['f_estatus_proyecto']) ? $_SESSION['scriptcase']['error_span_title']['f_estatus_proyecto'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['f_estatus_proyecto']) && '' != $_SESSION['scriptcase']['error_icon_title']['f_estatus_proyecto']) ? $_SESSION['scriptcase']['error_icon_title']['f_estatus_proyecto'] : '';
?>
