  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_f_estatus_proyecto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_estatus
  function do_ajax_f_estatus_proyecto_validate_id_estatus()
  {
    var nomeCampo_id_estatus = "id_estatus";
    var var_id_estatus = scAjaxGetFieldText(nomeCampo_id_estatus);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_estatus_proyecto_validate_id_estatus(var_id_estatus, var_script_case_init, do_ajax_f_estatus_proyecto_validate_id_estatus_cb);
  } // do_ajax_f_estatus_proyecto_validate_id_estatus

  function do_ajax_f_estatus_proyecto_validate_id_estatus_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_estatus_proyecto_validate_id_estatus_cb

  // ---------- Validate fecha_reporte
  function do_ajax_f_estatus_proyecto_validate_fecha_reporte()
  {
    ...
    setTimeout(function() {
      var var_fecha_reporte = scAjaxGetFieldText(nomeCampo_fecha_reporte);
      x_ajax_f_estatus_proyecto_validate_fecha_reporte(var_fecha_reporte, var_script_case_init, do_ajax_f_estatus_proyecto_validate_fecha_reporte_cb);
    }, 200);
  } // do_ajax_f_estatus_proyecto_validate_fecha_reporte

  function do_ajax_f_estatus_proyecto_validate_fecha_reporte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_estatus_proyecto_validate_fecha_reporte_cb

  // ---------- Validate avance
  function do_ajax_f_estatus_proyecto_validate_avance()
  {
    var nomeCampo_avance = "avance";
    var var_avance = scAjaxGetFieldText(nomeCampo_avance);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_estatus_proyecto_validate_avance(var_avance, var_script_case_init, do_ajax_f_estatus_proyecto_validate_avance_cb);
  } // do_ajax_f_estatus_proyecto_validate_avance

  function do_ajax_f_estatus_proyecto_validate_avance_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "avance";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_estatus_proyecto_validate_avance_cb

  // ---------- Validate finalizado
  function do_ajax_f_estatus_proyecto_validate_finalizado()
  {
    var nomeCampo_finalizado = "finalizado";
    var var_finalizado = scAjaxGetFieldText(nomeCampo_finalizado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_estatus_proyecto_validate_finalizado(var_finalizado, var_script_case_init, do_ajax_f_estatus_proyecto_validate_finalizado_cb);
  } // do_ajax_f_estatus_proyecto_validate_finalizado

  function do_ajax_f_estatus_proyecto_validate_finalizado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_estatus_proyecto_validate_finalizado_cb

  // ---------- Validate id_proyecto
  function do_ajax_f_estatus_proyecto_validate_id_proyecto()
  {
    var nomeCampo_id_proyecto = "id_proyecto";
    var var_id_proyecto = scAjaxGetFieldSelect(nomeCampo_id_proyecto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_f_estatus_proyecto_validate_id_proyecto(var_id_proyecto, var_script_case_init, do_ajax_f_estatus_proyecto_validate_id_proyecto_cb);
  } // do_ajax_f_estatus_proyecto_validate_id_proyecto

  function do_ajax_f_estatus_proyecto_validate_id_proyecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_f_estatus_proyecto_validate_id_proyecto_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_f_estatus_proyecto_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_f_estatus_proyecto_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_f_estatus_proyecto_submit_form(var_id_estatus, var_fecha_reporte, var_avance, var_finalizado, var_id_proyecto, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_f_estatus_proyecto_submit_form_cb);
  } // do_ajax_f_estatus_proyecto_submit_form

  function do_ajax_f_estatus_proyecto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_f_estatus_proyecto_submit_form_cb_after_alert);
  } // do_ajax_f_estatus_proyecto_submit_form_cb
  function do_ajax_f_estatus_proyecto_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_f_estatus_proyecto_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_f_estatus_proyecto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_f_estatus_proyecto_navigate_form(var_id_estatus, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_f_estatus_proyecto_navigate_form_cb);
  } // do_ajax_f_estatus_proyecto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['f_estatus_proyecto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_f_estatus_proyecto_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_f_estatus_proyecto_form();
    }
    scAjaxClearErrors()
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_f_estatus_proyecto_navigate_form_cb_after_alert);
  } // do_ajax_f_estatus_proyecto_navigate_form_cb
  function do_ajax_f_estatus_proyecto_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_f_estatus_proyecto_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_f_estatus_proyecto_navigate_form_cb_after_alert
  function sc_hide_f_estatus_proyecto_form()
  {
